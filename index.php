...
if ($callbackQuery = $update->getCallbackQuery()) {
    ...
    switch ($callbackData){
        ...
        case "Senioren":
            ...
            $sendMessage->setReplyMarkup($keyboard);
            $bot->sendMessage(new SendMessage($callbackQuery->getMessage()->getChat()->getId(),'Alles klar! Ich merke mir diese Einstellung für zukünftige Fragen. %0A Wenn du deine Auswahl später ändern willst schicke mir einfach eine neue Nachricht mit /start'));
            $bot->sendMessage($sendMessage);
